...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_moonlander(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, DK_CIRC, S(DK_SLSH), DK_LBRC, DK_RBRC, _______, DK_TILD,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, DK_LCBR, DK_RCBR, DK_PLUS,_______,
    ...
    [_RAISE] = LAYOUT_moonlander(
        _______, DK_EXLM, DK_QUOT, DK_HASH, _______, DK_PERC, _______, _______, _______, _______, DK_PIPE , _______ ,_______    , DK_ARNG,
        _______, DK_AT, DK_ASTR  , DK_DLR, DK_EQL, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, DK_AE, DK_OSTR,
